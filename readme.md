...
- 🛍 Browse items in card format (Name, Price, Image, Add to Cart button)
...
1. *Clone the repository*
   bash
   git clone https://github.com/Prajwal5028/Inventory-Management.git
...
Developed by *Prajwal Kumbar*  
📧 pkumbar273@gmail.com  
🌐 [GitHub](https://github.com/Prajwal5028/Inventory-Management)
